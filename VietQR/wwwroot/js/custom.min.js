    ...
    $SIDEBAR_MENU.find("a").on("click", function (b) {
        ...
        $BODY.hasClass("nav-md") ? ($SIDEBAR_MENU.find("li.active ul").hide(), $SIDEBAR_MENU.find("li.active").addClass("active-sm").removeClass("active")) : ($SIDEBAR_MENU.find("li.active-sm ul").show(), $SIDEBAR_MENU.find("li.active-sm").addClass("active").removeClass("active-sm")), $BODY.toggleClass("nav-md nav-sm"), a()
            ...
            if($('#resize_image').length)
            {
                      ...
                      var rows = $('#resize_image').find("img");
                     
                       for (i = 0; i < rows.length; i++) {
                           if(sessionStorage.getItem('resize-menu') == "nav-sm")
                                        {
                                                rows[i].classList.remove("ResizeImage");
                                        ...
                                        else
                                        {
                                                ...
                                                rows[i].classList.remove("ResizeImage2");
        ...
        //Màn hình nhỏ hơn < 768 hiện thanh menu cho điện thoại
                var screen_width = $(window).width();
                if (screen_width <= 768) {
                    $BODY.removeClass("nav-md");
                    $BODY.addClass("nav-sm");
...
function init_daterangepicker_single_call() {
    ...
    const minday = new Date(year, month, date);
    minday.setDate(minday.getDate() - 200);
    ...
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_single_call"), $("#single_cal1").daterangepicker({
        ...
        singleDatePicker: !0,
        minDate: minday, //set minday lấy từ dòng 1210
        locale: {
            format: 'DD/MM/YYYY'
        },
        singleClasses: "picker_4"
        ...
        $("#single_cal6").daterangepicker({
            singleDatePicker: !0,
            autoUpdateInput: false,//làm rỗng
            locale: {
                format: 'DD/MM/YYYY',
            },
        ...
        $('#single_cal6').on('apply.daterangepicker', function (ev, picker) {
            $(this).val(picker.startDate.format('DD/MM/YYYY')); //lấy dữ liệu khi chọn
        }))
}
