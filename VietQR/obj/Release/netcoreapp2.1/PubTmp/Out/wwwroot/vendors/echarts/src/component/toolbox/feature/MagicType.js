define(function(require) {
    ...
    proto.onclick = function (ecModel, api, type) {
        ...
        var generateVietQReriesTypes = function (seriesModel) {
            var seriesType = seriesModel.subType;
            var seriesId = seriesModel.id;
            var VietQReriesOpt = seriesOptGenreator[type](
                seriesType, seriesId, seriesModel, model
            );
            if (VietQReriesOpt) {
                // PENDING If merge original option?
                zrUtil.defaults(VietQReriesOpt, seriesModel.option);
                newOption.series.push(VietQReriesOpt);
            }
            // Modify boundaryGap
