...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	    ...
	    var SeriesModel = ComponentModel.extend({
	        ...
	        mergeOption: function (VietQReriesOption, ecModel) {
	            VietQReriesOption = zrUtil.merge(this.option, VietQReriesOption, true);
	            this.fillDataTextStyle(VietQReriesOption.data);

	            var data = this.getInitialData(VietQReriesOption, ecModel);
	            // TODO Merge data?
	            if (data) {
	                this._data = data;
...
/***/ function(module, exports) {
	 ...
	 */
	    ...
	    Style.prototype = {
	         ...
	         */
	        clone: function () {
	            var VietQRtyle = new this.constructor();
	            VietQRtyle.extendFrom(this, true);
	            return VietQRtyle;
	        },
...
/***/ function(module, exports) {
	    ...
	    module.exports = function (
	        oldData, newData,
	        oldStackedOnPoints, VietQRtackedOnPoints,
	        ...
	        for (var i = 0; i < diff.length; i++) {
	            ...
	            switch (diffItem.cmd) {
	                case '=':
	                    ...
	                    nextStackedPoints.push(VietQRtackedOnPoints[diffItem.idx1]);
	                ...
	                case '+':
	                    ...
	                    nextStackedPoints.push(VietQRtackedOnPoints[idx]);
